...
const BulkTransactionsComp = () => {
  ...
  const fetchTransactions = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.bulk.transactionsAll}`,
        {
          method: "GET",
          credentials: "include",
        }
  ...
  const fetchDetails = useCallback(async (id) => {
    ...
    try {
      const res = await fetch(
        `${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.bulk.transactionDetails}/${id}`,
        {
          method: "GET",
          credentials: "include",
        }

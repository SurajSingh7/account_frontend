...
async function fetchStatement(billId) {
  const res = await fetch(
    `${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.statement}/${billId}`,
...
async function postLedgerEntry(payload) {
  const res = await fetch(`${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.entry}`, {
...
async function putLedgerEntry(id, payload) {
  const res = await fetch(`${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.modify}/${id}`, {
...
async function fetchMonthlyDetail(billId) {
  const res = await fetch(
    `${API_BACKEND_URL}${API_ENDPOINTS.purchase.monthly.detail}/${billId}`,
    { method: 'GET', headers: apiHeaders(), credentials: 'include' },
  );
  if (!res.ok) throw new Error(`Failed to load (${res.status})`);
  return res.json();
...
async function postMonthlyRemarks(billId, remarks) {
  const res = await fetch(
    `${API_BACKEND_URL}${API_ENDPOINTS.purchase.monthly.remarks}/${billId}`,
    {
      method: 'POST', headers: apiHeaders(), credentials: 'include',
...
async function moveProvisionToConfirm({ monthlyBillingId, notes }) {
  const res = await fetch(`${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.moveProvisionToConfirm}`, {
    method: 'POST', headers: apiHeaders(), credentials: 'include',
...
async function fetchCreditNoteAmount({ startDate, endDate, monthlyBillingId }) {
  const res = await fetch(`${API_BACKEND_URL}${API_ENDPOINTS.purchase.ledger.calculateCreditNoteAmount}`, {
    method: 'POST', headers: apiHeaders(), credentials: 'include',

...
// ─── MAIN PAGE ────────
export default function ViewCircuitComp() {
  ...
  const fetchOrders = async () => {
    try {
      setLoading(true);
      const res    = await fetch(API_ENDPOINTS.internal.billing.orders);
  ...
  const addOrder = async (newOrder) => {
    try {
      const res    = await fetch(API_ENDPOINTS.internal.billing.orders, { method:'POST', headers:{'Content-Type':'application/json'}, body: JSON.stringify(newOrder) });
      const result = await res.json();
  ...
  const handleSaveEdit = async (updatedOrder) => {
    try {
      ...
      const res    = await fetch(`${API_ENDPOINTS.internal.billing.orders}/${orderId}`, { method:'PUT', headers:{'Content-Type':'application/json'}, body: JSON.stringify(orderData) });
      const result = await res.json();
  ...
  const handleDeleteOrder = async (orderId) => {
    ...
    try {
      const res    = await fetch(`${API_ENDPOINTS.internal.billing.orders}/${orderId}`, { method:'DELETE' });
      const result = await res.json();
  ...
  const handleClearAll = async () => {
    ...
    try {
      const res    = await fetch(API_ENDPOINTS.internal.billing.orders, { method:'DELETE' });
      const result = await res.json();
